...
const initialPatients: PatientRecord[] = [
  {
    ...
    medicalHistory: "High BP history",
    currentMedication: "BP medicine",
  ...
  },
  {
    ...
    date: "2026-05-01",
    timeSlot: "৩টা - ৪টা",
    serialType: "Follow-up",
    symptoms: "Regular pregnancy checkup",
    medicalHistory: "No major history",
    currentMedication: "Vitamin supplement",
    allergies: "No allergy",
    tests: ["Ultrasound", "Blood Test / Pathology"],
    address: "মিঠাপুকুর, রংপুর",
    district: "রংপুর",
    upazila: "মিঠাপুকুর",
    emergencyName: "করিম",
    emergencyRelation: "স্বামী",
    emergencyPhone: "01800000002",
    paymentMethod: "bKash",
  ...
  },
  {
    ...
    date: "2026-05-02",
    timeSlot: "১০টা - ১১টা",
    serialType: "Emergency Serial",
    symptoms: "জ্বর, মাথা ব্যথা",
    medicalHistory: "Frequent fever",
    currentMedication: "Paracetamol",
    allergies: "Dust allergy",
    tests: ["CBC", "Blood Test / Pathology"],
    address: "পীরগঞ্জ, রংপুর",
    district: "রংপুর",
    upazila: "পীরগঞ্জ",
    emergencyName: "সালাম",
    emergencyRelation: "ভাই",
    emergencyPhone: "01800000003",
    paymentMethod: "Cash",
    transactionId: "",
    onlineConsultation: false,
    homeService: false,
  ...
  },
  {
    ...
    timeSlot: "৫টা - ৬টা",
    serialType: "Regular Serial",
    symptoms: "রক্তচাপ বেশি, বুক ধড়ফড়",
    medicalHistory: "High BP",
    currentMedication: "Amlodipine",
    allergies: "No allergy",
    tests: ["ECG"],
    address: "তারাগঞ্জ, রংপুর",
    district: "রংপুর",
    upazila: "তারাগঞ্জ",
    emergencyName: "জামাল",
    emergencyRelation: "স্বামী",
    emergencyPhone: "01800000004",
    paymentMethod: "Nagad",
    transactionId: "NAGAD004",
  ...
  },
  {
    ...
    timeSlot: "১১টা - ১২টা",
    serialType: "Regular Serial",
    symptoms: "গ্যাস্ট্রিক সমস্যা, শরীর দুর্বল",
    medicalHistory: "Gastric problem",
    currentMedication: "Antacid",
    allergies: "No allergy",
  ...
  },
  {
    ...
    timeSlot: "৪টা - ৫টা",
    serialType: "Regular Serial",
    symptoms: "গাইনি নিয়মিত চেকআপ",
    medicalHistory: "No major issue",
    currentMedication: "None",
    allergies: "No allergy",
    tests: ["Ultrasound"],
    address: "সৈয়দপুর, নীলফামারী",
    district: "নীলফামারী",
    upazila: "সৈয়দপুর",
    emergencyName: "মাহমুদ",
    emergencyRelation: "স্বামী",
    emergencyPhone: "01800000006",
    paymentMethod: "Card",
    transactionId: "CARD006",
    onlineConsultation: false,
    homeService: false,
    reportDelivery: "Email",
    consentConfirmed: true,
  ...
  },
  {
    ...
    emergencyName: "ফারুক",
    emergencyRelation: "ভাই",
    emergencyPhone: "01800000007",
    paymentMethod: "Rocket",
    transactionId: "ROCKET007",
    onlineConsultation: true,
    homeService: false,
    reportDelivery: "WhatsApp",
    consentConfirmed: true,
  ...
  },
  {
    ...
    consentConfirmed: true,
    privacyAccepted: true,
    inquirySubject: "Service information",
    inquiryMessage: "ডাক্তারের সময়সূচি এবং টেস্ট খরচ জানতে চাই।",
    customAnswers: {},
    status: "Pending",
    createdAt: "2026-05-04",
  },
  {
    ...
    timeSlot: "৬টা - ৮টা",
    serialType: "Emergency Serial",
    symptoms: "হৃদস্পন্দন অনিয়মিত",
    medicalHistory: "No major history",
    currentMedication: "None",
    allergies: "No allergy",
    tests: ["ECG"],
    address: "পলাশবাড়ী, গাইবান্ধা",
    district: "গাইবান্ধা",
    upazila: "পলাশবাড়ী",
    emergencyName: "মামুন",
    emergencyRelation: "বন্ধু",
    emergencyPhone: "01800000009",
    paymentMethod: "bKash",
    transactionId: "BKASH009",
    onlineConsultation: false,
    homeService: false,
    reportDelivery: "WhatsApp",
    consentConfirmed: true,
  ...
  },
  {
    ...
    medicalHistory: "No major history",
    currentMedication: "Iron supplement",
    allergies: "No allergy",
    tests: ["Blood Test / Pathology", "Ultrasound"],
    address: "ডোমার, নীলফামারী",
    district: "নীলফামারী",
    upazila: "ডোমার",
    emergencyName: "সুমন",
    emergencyRelation: "ভাই",
    emergencyPhone: "01800000010",
    paymentMethod: "Cash",
    transactionId: "",
    onlineConsultation: false,
    homeService: true,
    reportDelivery: "Courier",
    consentConfirmed: true,
    privacyAccepted: true,
    inquirySubject: "",
    inquiryMessage: "",
...
function createPatientId() {
  ...
  return `patient-${Date.now()}-${Math.random().toString(36).slice(2, 8)}`;
}

function createNextSerialNo(patients: PatientRecord[]) {
  const highestSerialNumber = patients.reduce((highest, patient) => {
    const serialNumber = Number(patient.serialNo.replace(/^SL-/, ""));
  ...
  return `SL-${String(highestSerialNumber + 1).padStart(3, "0")}`;
}
...
export default function PatientAdminPage() {
  ...
  function addCustomField(event: FormEvent<HTMLFormElement>) {
    ...
    setIsCustomFieldModalOpen(false);
    showToast(
      `${label} ${getCustomFieldTypeLabel(customFieldType)} field saved`,
    );
  }
  ...
  function savePatient(event: FormEvent<HTMLFormElement>) {
    ...
    const serialNo = createNextSerialNo(patients);
  ...
  function openPrintToken(patient: PatientRecord) {
    setPrintPatient(patient);
  }

  function closePrintToken() {
    setPrintPatient(null);
  }

  function printPatientToken() {
    if (!printPatient) return;

    const printWindow = window.open("", "_blank", "width=420,height=650");

    if (!printWindow) {
      alert("Please allow popup to print token");
      return;
    }
    ...
    <html>
      <head>
        <title>${printPatient.serialNo} Token</title>
        <style>
          * {
      ...
      <body>
        <div class="token">
          <div class="clinic">
            <h1>Clinic & Diagnostic Center</h1>
            <p>Patient Serial Token</p>
          </div>

          <div class="serial">
            <span>${printPatient.serialNo}</span>
          </div>

          <div class="row">
            <div class="label">Name</div>
            <div class="value">${printPatient.fullName}</div>
          </div>

          <div class="row">
            <div class="label">Phone</div>
            <div class="value">${printPatient.phone}</div>
          </div>

          <div class="row">
            <div class="label">Type</div>
            <div class="value">${printPatient.userType}</div>
          </div>

          <div class="row">
            <div class="label">Doctor / Inquiry</div>
            <div class="value">
              ${
                printPatient.userType === "Patient"
                  ? printPatient.doctorName
                  : printPatient.inquirySubject || "General Inquiry"
              }
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="value">${printPatient.date || "No date"}</div>
          </div>

          <div class="row">
            <div class="label">Time</div>
            <div class="value">${printPatient.timeSlot || "No slot"}</div>
          </div>

          <div class="row">
            <div class="label">Status</div>
            <div class="value">${printPatient.status}</div>
          </div>

          <div class="footer">
            Please bring this token during your visit.
          </div>
        </div>
    ...
    <div className="space-y-4">
                  ...
                  filteredPatients.map((patient) => (
                    ...
                    >
                      ...
                      <div className="grid grid-cols-4 gap-2 xl:flex xl:justify-end">
                        ...
                        <button
                          type="button"
                          onClick={() => openPrintToken(patient)}
                          className="inline-flex items-center justify-center gap-1.5 rounded-xl border border-teal-100 px-3 py-2 text-xs font-black text-teal-700 transition hover:bg-teal-50"
                        >
      ...
      {printPatient ? (
        ...
        >
          ...
          >
            <div className="flex items-start justify-between gap-3 border-b border-slate-100 bg-slate-950 px-5 py-4 text-white">
              <div>
                <h2 className="text-lg font-black">Print Token</h2>
                <p className="mt-1 text-xs text-slate-300">
                  Patient serial token preview
                </p>
              </div>
            ...
            <div className="p-5">
              <div className="rounded-3xl border border-slate-200 bg-white p-5">
                ...
                <div className="py-5 text-center">
                  <span className="inline-flex rounded-full bg-teal-600 px-5 py-2 text-2xl font-black text-white">
                    {printPatient.serialNo}
                  </span>
                </div>
